...
Exit code 137 = `SIGKILL` (128+9), typically the Linux OOM killer terminating the build process. GitHub Actions standard runners have ~7GB RAM; large multi-stage builds (especially with compiled dependencies like Node.js native modules or Rust) can exceed this.
...
```bash
# 1. Build completes without exit 137
