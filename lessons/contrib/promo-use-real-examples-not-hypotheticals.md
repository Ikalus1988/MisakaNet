...
- "FANUC 1086 不是 error code 是 line number" — 这种Error只有亲历者才写得出

## Fix

写引流文案时，从 lessons/ Directory里挑真实案例：

1. 扫 lessons/ Directory，找**最有戏剧性**的故事（浪费时间最长、最反直觉）
