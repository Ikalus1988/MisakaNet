...
部署了 LLM 服务（vLLM/Ollama/本地推理）后，不知道怎么用 API 调用。各框架Interface不一。

## 根因

大部分 LLM 服务实现了 OpenAI 兼容的 API 格式，但端点和Parameter细节有差异。
...
url = "http://localhost:11434/v1/chat/completions"  # Ollama Example
