...
> **Stop debugging the same error twice.** MisakaNet searches 412+ failure lessons so an agent skips the
...
serves 412+ **indexed failure-recovery lessons** — *indexed*, never "verified": evidence level is what says
