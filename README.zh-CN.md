...
MisakaNet 是面向 AI 编码 Agent 的失败经验层。当你的 Agent 遇到错误 —— DCO 失败、pip 超时、GitHub 401、MCP 配置问题 —— MisakaNet 搜索 393 条索引化的失败修复经验并返回修复路径。无 prompt 泄漏，无原始日志存储。
